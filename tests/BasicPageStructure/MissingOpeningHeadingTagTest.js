                        ...
                        describe('<title> element: ', async function() {
                            it('The inner element of the <head> element should be the <title> element.', async function() {
                                ...
                                if(headChildren[0].tagName == 'TITLE') {
                                    describe('<title> element: ', async function() {
                                        it('The text enclosed inside the <title> element should be "HTML Practice".', async function() {
                                            assert.equal(headChildren[0].textContent.trim(), 'HTML Practice');
                                        });
                                    });
                                }
                            });
                ...
                it('The inner elements of the <body> element should be one <h1> element followed by one <p> element.', async function() {
                    ...
                    if(bodyChildren[0]) {
                        describe('<h1> element: ', async function() {
                            it('The first inner element of the <body> element should be the <h1> element.', async function() {
                                assert.equal(bodyChildren[0].tagName, 'H1');

                                if(bodyChildren[0].tagName == 'H1') {
                                    describe('<h1> element: ', async function() {
                                        it('The text enclosed inside the <h1> element should be "This text is inside the heading."', async function() {
                    ...
                    if(bodyChildren[1]) {
                        describe('<p> element: ', async function() {
                            it('The second inner element of the <body> element should be the <p> element.', async function() {
                                assert.equal(bodyChildren[1].tagName, 'P');

                                if(bodyChildren[1].tagName == 'P') {
                                    describe('<p> element: ', async function() {
                                        it('The text enclosed inside the <p> element should be "This text is inside a paragraph.".', async function() {
